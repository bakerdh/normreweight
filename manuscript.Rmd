...
author: Daniel H. Baker, Daniela Marinova, Richard Aveyard, Lydia Hargreaves, Alice
  Renton, Ruby Castellani, Phoebe Hall, Miriam Harmens, Georgia Holroyd,
...
plotlims <- c(1,20,0,3)  # define the x and y limits of the plot (minx,maxx,miny,maxy)
ticklocsx <- seq(2,20,2)    # locations of tick marks on x axis
ticklocsy <- c(0,0.4,0.8,1,2,3)    # locations of tick marks on y axis
ticklabelsx <- seq(2,20,2)        # set labels for x ticks
